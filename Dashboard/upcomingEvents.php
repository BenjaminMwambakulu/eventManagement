                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                <div class='action-buttons'>
                                    <a href='#' class='approve' onclick=\"openModal('Are you sure you want to Approve this event?', '../php/eventCycleManagement.php?id=" . $row['id'] . $Archive . "')\">Archive</a>
                                    <a href='edit_event.php?id=" . $row['id'] . "' style='color:#000'><i class='fas fa-edit'></i>Edit</a> <br>
                                    <a href='listOfRegisteredUsers.php?id=" . $row['id'] . "' style='color:#000'><i class='fas fa-users'></i>View</a>                                     </div>
                            </td>";
                                    echo "</tr>";
                                }
                            } else {
