...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="./eventDiscovery.php" class="navActive">Upcoming Events</a></li>
    ...
    $sql = "SELECT id,event_name, event_date, event_venue, event_description, price_category, event_price, start_time, end_time, event_poster FROM approved_events";
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <p style="line-height: 1.5; color:#708090">
                            ...
                            <?php
                            echo '<a href="eventDetails.php?event_id=' . $row['id'] . '&from=upComingEventDetail" class="View-More">View More</a>';
                            ?>
                        </p>
                    </div>
                </div>
